...
//  TheBigBangTheory
//
//  Created by Eduardo Santiz on 4/21/19.
...
struct KeychainPasswordItem {
    ...
    func savePassword(password: String) throws {
        ...
        do {
            ...
            var attributesToUpdate: [String: AnyObject] = [String: AnyObject]()
    ...
    mutating func renameAccount(newAccountName: String) throws {
        ...
        // Throws an error if an unexpected status was returned.
    ...
    static func passwordItems(forService service: String, accessGroup: String? = nil) throws -> [KeychainPasswordItem] {
        ...
        var passwordItems: [KeychainPasswordItem] = [KeychainPasswordItem]()
